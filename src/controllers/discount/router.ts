...
discountRouter.get('/', async(req:express.Request, res:express.Response)=>{
    try{
...
discountRouter.get('/:id',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
...
discountRouter.post('/',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
    const {data}=req.body
    if(data){
...
discountRouter.patch('/:id', async (req:express.Request, res:express.Response)=>{
...
discountRouter.delete('/:id',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
    const {id}=req.params
    if(id){
