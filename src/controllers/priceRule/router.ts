...
import { PriceRuleInput } from "./input";
...
export const priceRuleRouter=express.Router()


priceRuleRouter.get('/', async(req:express.Request, res:express.Response)=>{
    try{
...
priceRuleRouter.get('/:id', async (req:express.Request, res:express.Response)=>{
...
priceRuleRouter.post('/',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
    const {data}=req.body
    if(data){
...
priceRuleRouter.patch('/:id',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
    let {data}=req.body
...
priceRuleRouter.delete('/:id',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
    const {id}=req.params
    if(id){
