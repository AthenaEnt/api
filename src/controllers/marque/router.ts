...
export const marqueRouter=express.Router()


marqueRouter.get('/', async(req:express.Request, res:express.Response)=>{
    try{
...
marqueRouter.get('/:id', async (req:express.Request, res:express.Response)=>{
...
marqueRouter.post('/',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
    const {data}=req.body
    if(data){
...
marqueRouter.patch('/:id',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
...
marqueRouter.delete('/:id',authOnlyAdmin, async (req:express.Request, res:express.Response)=>{
    const {id}=req.params
    if(id){
